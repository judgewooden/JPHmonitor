...
while True:
    try:
        ...
        print("KastTemp1: Cannot Connect to SQL (retry)")
        time.sleep(5)
        continue
    break

# GLOBAL
add_temp = ("INSERT INTO KastTemperature1 "
               "(Timestamp, Temperature, Humidity) "
               "VALUES (%s, %s, %s)")

while True:
    tnow = datetime.now()
    # 20 is the GPIO number for the pin connect
    humidity, temperature = Adafruit_DHT.read_retry(Adafruit_DHT.AM2302, 20)
